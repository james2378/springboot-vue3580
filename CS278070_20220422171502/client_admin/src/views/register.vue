			...
			<el-row>
				<el-col>
					<el-form :model="form" ref="form" label-width="80px" class="form">
						...
						<!-- 用户注册 -->
						<form_user_registration v-if="form.user_group === '用户注册'" :form="form_sub" ></form_user_registration>
...
<script>
	...
	/* 用户注册 */
	import form_user_registration from "@/components/diy/form_user_registration";
