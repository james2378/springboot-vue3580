<template>
	<el-main class="bg table_wrap">
			...
			<el-row>
				<el-col :xs="24" :sm="24" :lg="8" class="el_form_search_wrap">
					<el-form-item label="招聘职位">
						<el-input v-model="query.recruitment_position"></el-input>
					</el-form-item>
				</el-col>
				<el-col :xs="24" :sm="24" :lg="8" class="el_form_search_wrap">
					<el-form-item label="招聘人数">
						<el-input-number v-model="query.number_of_recruits"></el-input-number>
					</el-form-item>
				</el-col>
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column prop="recruitment_time" label="招聘时间"
				v-if="user_group == '管理员' || $check_field('get','recruitment_time')" min-width="200">
			</el-table-column>
			<el-table-column prop="age_requirements" label="年龄要求"
				v-if="user_group == '管理员' || $check_field('get','age_requirements')" min-width="200">
			</el-table-column>
			<el-table-column prop="salary_forecast" label="工资预计"
				v-if="user_group == '管理员' || $check_field('get','salary_forecast')" min-width="200">
			</el-table-column>
			...
			<el-table-column prop="experience_requirements" label="经验要求"
				v-if="user_group == '管理员' || $check_field('get','experience_requirements')" min-width="200">
			</el-table-column>
			...
			<el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/recruitment_information/table','set') || $check_action('/recruitment_information/view','set') || $check_action('/recruitment_information/view','get') || $check_action('/投递简历/table','add') || $check_action('/投递简历/view','add')" >
				...
				<template slot-scope="scope">
					...
					<!--跨表按钮-->
					<el-button class="el-button el-button--small is-plain el-button--default" style="margin: 5px !important;" size="small" @click="to_table(scope.row,'/resume_management/view')" v-if="user_group == '管理员' || $check_action('/resume_management/table','add') || $check_action('/resume_management/view','add')">
						<span>投递简历</span>
					</el-button>
				</template>
			</el-table-column>
